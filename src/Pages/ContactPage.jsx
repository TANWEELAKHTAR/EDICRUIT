...
const ContactPage = () => {
  return (
    <section className="w-full min-h-fit bg-[#121211] text-white">
      ...
      <div className="w-full  h-fit lg:h-screen flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/2 h-full flex items-center justify-center flex-col p-8">
        <img className="w-full md:w-3/5 h-full md:h-fit object-cover" src="./images/map.png" alt="" />
        </div>
        <div className="w-full lg:w-1/2 h-full flex items-center justify-center flex-col gap-8 p-8">
        <h1 className="text-5xl md:text-7xl capitalize font-semibold">
            our location
          </h1>
          <p className="text-sm md:text-base md:w-5/6">
